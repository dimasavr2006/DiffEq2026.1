...
\tikzset{every picture/.append style={semithick, line cap=round, line join=round, >=Stealth}}
...
\newtcbtheorem[no counter]{exampleth}{Пример}{
	enhanced, breakable, colback=excolor!5, colframe=excolor,
	fonttitle=\bfseries, sharp corners
}{ex}

% Simple example environment without required arguments
...
\newcommand{\subjectName}{Дифференциальные уравнения} 
\setlength{\headheight}{30pt}

% ВЕРХНИЙ КОЛОНТИТУЛ
\lhead{\parbox[b]{0.36\textwidth}{\raggedright\small \textsc{\subjectName}}} % Слева название предмета
\rhead{\parbox[b]{0.60\textwidth}{\raggedleft\scriptsize \nouppercase{\leftmark}}} % Справа название лекции
...
\hypersetup{
	...
	filecolor=magenta,      
	urlcolor=cyan,
	pdftitle={Конспект по дифференциальным уравнениям},
}
