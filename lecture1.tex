...
\begin{proofbox}
	...
	\begin{align}
		\dv{\tilde{x}_i}{t} + \dv{\varphi_i}{t} &= f_i(\tilde{x}_1 + \varphi_1, \dots, \tilde{x}_n + \varphi_n, t) \notag \\
		\iff \dv{\tilde{x}_i}{t} &= F_i(\tilde{x}_1, \dots, \tilde{x}_n, t), \quad i=1,2,\dots,n \quad (205) \label{eq:205}
	\end{align}
	...
	Заметим, что поскольку $\varphi_i$ является решением системы \eqref{eq:198}, то есть оно удовлетворяет системе ур-ний:
	$$\dv{\varphi_i}{t} = f_i(\varphi_1, \varphi_2, \dots, \varphi_n, t) \quad (206)$$
	то
	$$F_i(0, 0, \dots, 0, t) = f_i(\varphi_1, \varphi_2, \dots, \varphi_n, t) - \dv{\varphi_i}{t} = 0 \quad (207).$$
