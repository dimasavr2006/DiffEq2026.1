...
\begin{proofbox}
	...
	$$ \dv{\tilde{x}_i}{t} + \dv{\varphi_i}{t} = f_i(\tilde{x}_1 + \varphi_1, \dots, \tilde{x}_n + \varphi_n, t) \iff \dv{\tilde{x}_i}{t} = F_i(\tilde{x}_1, \dots, \tilde{x}_n, t), \quad i=1,2,\dots,n \quad (205) \label{eq:205} $$
